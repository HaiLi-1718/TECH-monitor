...
# On main/master: skip if ONLY scripts/, docs/, .github/, or non-web files changed
if { [ "$VERCEL_GIT_COMMIT_REF" = "main" ] || [ "$VERCEL_GIT_COMMIT_REF" = "master" ]; } && [ -n "$VERCEL_GIT_PREVIOUS_SHA" ]; then
