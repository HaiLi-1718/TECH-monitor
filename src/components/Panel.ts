...
export class Panel {
  ...
  public showLocked(features: string[] = []): void {
    ...
    const ctaBtn = h('button', { type: 'button', className: 'panel-locked-cta', disabled: 'true' }, t('premium.joinWaitlist'));
  ...
  /** Cancel a debounced `setContent` update (subclasses use before showing empty/error states). */
  protected cancelPendingContentUpdate(): void {
