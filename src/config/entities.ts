import { TECH_MONITORING_COMPANIES } from './tech-monitoring-companies';
...
export const ENTITY_REGISTRY: EntityEntry[] = [
  ...
  },
  {
    ...
    type: 'company',
    name: 'OpenAI',
    aliases: ['openai', 'chatgpt', 'gpt-4', 'gpt-4o', 'sam altman'],
    keywords: ['large language model', 'foundation model', 'api', 'reasoning model', 'ai model'],
    sector: 'AI',
    related: ['MSFT', 'ANTHROPIC', 'GOOGL', 'META'],
  },
  {
    id: 'ANTHROPIC',
    type: 'company',
    name: 'Anthropic',
    aliases: ['anthropic', 'claude ai', 'claude'],
    keywords: ['llm', 'ai safety', 'constitutional ai', 'foundation model'],
    sector: 'AI',
    related: ['OPENAI', 'GOOGL', 'AMZN'],
  },
  {
    id: 'XAI',
    type: 'company',
    name: 'xAI',
    aliases: ['xai', 'grok', 'elon musk ai'],
    keywords: ['grok', 'foundation model', 'ai model', 'inference'],
    sector: 'AI',
    related: ['OPENAI', 'META', 'GOOGL'],
  },
  {
    id: 'C3AI',
    type: 'company',
    name: 'C3.ai',
    aliases: ['c3.ai', 'c3 ai', 'ai software company'],
    keywords: ['enterprise ai', 'ai software', 'predictive analytics'],
    sector: 'AI',
    related: ['PLTR', 'DATABRICKS', 'MSFT'],
  },
  {
    id: 'SCALEAI',
    type: 'company',
    ...
    keywords: ['data labeling', 'model evaluation', 'foundation model data'],
    sector: 'AI',
    related: ['OPENAI', 'ANTHROPIC', 'DATABRICKS'],
  },
  {
    id: 'PLTR',
    type: 'company',
    ...
    keywords: ['ai platform', 'defense ai', 'data platform'],
    sector: 'AI',
    related: ['C3AI', 'MSFT', 'GOOGL'],
  },
  {
    id: 'DATABRICKS',
    type: 'company',
    name: 'Databricks',
    aliases: ['databricks'],
    keywords: ['lakehouse', 'data ai', 'machine learning platform', 'llmops'],
    sector: 'AI',
    related: ['SNOW', 'MSFT', 'SCALEAI'],
  },
  {
    id: 'NFLX',
    type: 'company',
  ...
  },
  {
    ...
    aliases: ['roche', 'hoffmann la roche'],
    keywords: ['biotech', 'oncology', 'diagnostics', 'clinical trial'],
    sector: 'Healthcare',
    related: ['NOVARTIS', 'PFE', 'AMGN'],
  },
  {
    id: 'NOVARTIS',
    type: 'company',
    name: 'Novartis AG',
    aliases: ['novartis'],
    keywords: ['pharma', 'drug pipeline', 'clinical trial', 'fda'],
    sector: 'Healthcare',
    related: ['ROCHE', 'PFE', 'LLY'],
  },
  {
    id: 'PFE',
    type: 'company',
    name: 'Pfizer Inc.',
    aliases: ['pfizer', 'pfe'],
    keywords: ['pharma', 'vaccine', 'drug development', 'clinical trial'],
    sector: 'Healthcare',
    related: ['MRK', 'JNJ', 'LLY'],
  },
  {
    ...
    name: 'Amgen, Inc.',
    aliases: ['amgen', 'amgn'],
    keywords: ['biotech', 'biologics', 'therapeutics', 'clinical trial'],
    sector: 'Healthcare',
    related: ['PFE', 'LLY', 'REGN'],
  },
  {
    id: 'REGN',
    type: 'company',
    ...
    keywords: ['biopharma', 'antibody', 'drug approval', 'clinical trial'],
    sector: 'Healthcare',
    related: ['AMGN', 'PFE', 'LLY'],
  },
  ...
  // ============================================================================
  // TECH MONITORING COMPANY LIST (from client-provided XLSX)
  // ============================================================================
  ...TECH_MONITORING_COMPANIES,
