...
export const VARIANT_META: {
  full: VariantMeta;
  localtech: VariantMeta;
  tech: VariantMeta;
  happy: VariantMeta;
  finance: VariantMeta;
  commodity: VariantMeta;
  ...
  localtech: {
    title: '科技监测 — 本地科技情报看板',
    description: '精简版科技监测：科技新闻、公司与活动地图；可选连接本机 Ollama / LM Studio 做摘要与轻量模型测试。',
    keywords: '科技监测, 本地部署, Ollama, 科技新闻, 科技公司, 技术活动, tech news, local LLM',
    url: 'http://localhost:5173/',
    siteName: '科技监测',
    shortName: '科技监测',
    subject: 'Technology monitoring (local)',
    classification: 'Tech dashboard, local LLM',
    categories: ['news', 'productivity'],
    features: [
      '科技新闻聚合',
      '科技公司 / 总部地图',
